...
This is an ongoing project of porting core functionality from the SoFiA-2 HI-Sorce finding algorithm to the GPU using cuda. This project is part of the B3D (https://www.b3d.nrw/) portfolio.
